...
public class BankAccountServiceImpl implements BankAccountService{
    ...
    public List<CustomerDTO> searchCustomers(String keyword) {
        ...
        List<CustomerDTO> customers=customerRepository.searchCustomer(keyword);
        List<CustomerDTO> customerDTOS=customers.stream().map(cust -> dtoMapper.fromCustomer((Customer) cust)).collect(Collectors.toList());
        return customerDTOS;
    }
